...
// gizmo manager
import MyGizmoManager from "./MyGizmoManager";

class Level {
  private _collisionArea: Mesh;
  private _gizmoManager: MyGizmoManager;
  ...
  constructor(
    ...
    this.player = player;
    //TODO : check point
    this._gizmoManager = new MyGizmoManager(scene);
  ...
  public async Load() {
    ...
    //parent mesh들만 관리하면 됨, child mesh들은 신경 안써도댐
